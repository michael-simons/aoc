...
image::https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdAW5nKwh3r08tCA7V87AVTm9d9CvS8vM1vU7XcOat6_7jGF0z&s[]
...
NOTE: Run with `java --source 13 --enable-preview Solution.java`.
      ...
      `rm *.class && javac --source 13 --enable-preview *.java && java --enable-preview -ea Tests`
